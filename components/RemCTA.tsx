...
const COPY: Record<Variant, { eyebrow: string; title: string; body: string }> = {
  ...
  "road-ahead": {
    ...
    body: "Eleven post-Acacia initiatives are in motion: sandbox, deposit token interoperability, tokenised government bonds, cross-border. If any of them touch your roadmap, talk to us early.",
  },
  "use-cases": {
    eyebrow: "Build with rem",
    title: "See a use case that maps to your business? Let's talk.",
    body: "Corporate bonds, securitised products, private markets, carbon. If a pattern from the cohort looks close to what you're building, we'd like to hear about it.",
  },
  participants: {
    eyebrow: "Build with rem",
