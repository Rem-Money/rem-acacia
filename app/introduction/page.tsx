      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container-rem">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }} className="gstats">
            <StatCard value="US$320B+" label="Stablecoin issuance" hint="May 2026, primarily USD non-bank issuers" accent="yellow" />
...
function Bullet({ children }: { children: React.ReactNode }) {
  return (
    <li style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
      <span style={{ width: 6, height: 6, borderRadius: 6, background: "rgba(255,255,255,0.35)", marginTop: 9, flexShrink: 0 }} />
...
function Mini({ year, name, desc }: { year: string; name: string; desc: string }) {
  return (
    <div className="card" style={{ padding: 18 }}>
      <div style={{ fontSize: 11, letterSpacing: "0.06em", textTransform: "uppercase", color: "rgba(255,255,255,0.5)", fontWeight: 700 }}>{year}</div>
