...
export const useCases: UseCase[] = [
  {
    ...
    leadId: "abe",
    participantIds: ["redbelly", "fieldrock", "fireblocks", "rand-low"],
    name: "Corporate Bond",
    type: "Pilot",
  ...
  },
  {
    ...
    leadId: "anz",
    participantIds: ["austraclear", "kwm"],
    name: "Corporate Bond",
    type: "PoC",
    assetClass: "Fixed income",
    assetSubClass: "Corporate bond",
  ...
  },
  {
    ...
    leadId: "anz",
    participantIds: ["global-packaging", "netwealth", "messagexchange", "rmit"],
    name: "Trade Payable",
    type: "PoC",
    assetClass: "Other",
  ...
  },
  {
    id: "apx-interchange",
    leadId: "apx",
    participantIds: ["hedera", "audd-digital", "cuscal", "forte", "macropod"],
  ...
  },
  {
    ...
    leadId: "cba",
    participantIds: ["kinexys", "hqlax", "gravital", "asx", "jpmorgan"],
    name: "Intraday Repo",
    type: "PoC",
    assetClass: "Fixed income",
    assetSubClass: "Repo",
  ...
  },
  {
    ...
    leadId: "fireblocks",
    participantIds: ["redbelly", "abe", "fasanara", "macropod", "northern-trust", "perpetual"],
  ...
  },
  {
    id: "forte-govt-bond",
    leadId: "forte",
    participantIds: ["ethereum", "cuscal", "coinspot"],
    name: "Government Bond",
    type: "Pilot",
    assetClass: "Fixed income",
    assetSubClass: "Government bond",
  ...
  },
  {
    ...
    participantIds: ["matrix-zenith", "swift", "csc", "westpac", "bt-panorama"],
    name: "Carbon Credits",
    type: "PoC",
    assetClass: "Other",
  ...
  },
  {
    ...
    participantIds: ["redbelly", "amal", "perpetual", "beachhead", "abe", "wisr"],
  ...
  },
  {
    ...
    leadId: "westpac",
    participantIds: ["imperium", "chainlink", "quintessencelabs"],
    name: "Term Deposit",
    type: "PoC",
    assetClass: "Fixed income",
    assetSubClass: "Term deposit",
